...
public class LocalDateTimeDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println(t3); // 严格按照ISO 8601格式打印
		System.out.println(d3); // 严格按照ISO 8601格式打印
		...
		// 日期变为31日:
		LocalDateTime dt10 = dt.withDayOfMonth(31);
		System.out.println(dt10); // 2019-10-31T20:30:59
		// 月份变为9:
		LocalDateTime dt11 = dt2.withMonth(9);
		...
		Duration dd2 = Duration.parse("P1DT2H3M");
